...
public class Cliente implements Serializable {
    ...
    public Cliente(String _name, Integer _points,Double posicionlineStartx,Double posicionlineStarty, Double posicionlineendx,Double posicionlineendy) {
        this.name = _name;
        this.puntos = _points;
        this.posicionlineStartx=posicionlineStartx;
        this.posicionlineStarty=posicionlineStarty;
        this.posicionlineendx=posicionlineendx;
        this.posicionlineendy=posicionlineendy;
    }
